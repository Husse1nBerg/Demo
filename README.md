...
- ✅ 5. End-to-End Testing: used Playwright to simulate a real user journey and test the UI.
- ✅ 6. Performance & Load Testing: used Locust to find your application's performance limits (Result: The application started to fail at 200 concurrent users w/ spawn rate of 20 new users per second., reaching a 27% failure rate under this load)
